...
You can also create formulas using specific cell values. If cells already have values placed in them. You can select these cells to use them for the formula. Now let’s go through a step by step example.
<br>
![Excel step by step example](/images/ribbon.png)
<br>
This can also be done using the fill operation.
<br>
![Excel step by step using fill example](/images/ribbon.png)
</div>