...
<li> Understanding the function of the undo and redo buttons. </li>
<li> Understanding how the undo and redo buttons are accessed. </li>
...
The redo function, on the other hand, reverses the Undo action. This is helpful when you regret using the undo function. To use the Redo function, press the button in the Ribbon. It should be placed directly under the Undo button. <br>

<p align="center">
  <img src="{{ '/static/redo_function.webp' | relative_url }}" alt="Excel Redo Function example"/>
</p>
<br><br>
<strong>Tip:</strong> You can also use the keyboard shortcut, <strong>CTRL + Y/Command + Y</strong>
<br><br>
<strong>Warning:</strong>The Redo command is only available if you have used the Undo function. 
</div>
