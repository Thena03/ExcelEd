...
<br><br>
<strong>Tip:</strong> The desktop app gives users the option to create fully customized conditional formatting rules. 
<br><br>
<p align="center">
  <img src="{{ '/static/conditional-formatting.png' | relative_url }}" alt="Excel Conditional Formatting example"/>
</p>
</div>

<div class="bg-white border-l-4 border-green-600 p-4 rounded-lg mb-6 shadow-sm"> 
<h2 class="text-2xl font-semibold text-center mb-4"> Highlighting Cell Rules </h2>
...
<br><br>
<p align="center">
  <img src="{{ '/static/highlight-cells.png' | relative_url }}" alt="Excel Highlighting Cells example"/>
</p>
<br> 
</div>

<div class="bg-white border-l-4 border-green-600 p-4 rounded-lg mb-6 shadow-sm"> 
<h2 class="text-2xl font-semibold text-center mb-4"> Appearance Options </h2>
The cell styles options that Excel offers allows users to add various themes to their spreadsheet. The most common cell styles are as follows: <br>
<ul class="list-disc list-inside">
<li> Light Red Fill with Dark Red Text </li>
<li> Yellow Fill with Dark Yellow Text </li>
<li> Green Fill with Dark Green Text </li>
<li> Light Red Fill </li>
<li> Red Text </li>
<li> Red Border </li>
</ul>
<br><br>
<p align="center">
  <img src="{{ '/static/cell-styles.png' | relative_url }}" alt="Excel Cell Styles example"/>
</p>
</div>