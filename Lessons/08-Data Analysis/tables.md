...
<div class="bg-white border-l-4 border-green-600 p-4 rounded-lg mb-6 shadow-sm"> 
<h2 class="text-2xl font-semibold text-center mb-4"> Table Design</h2>
Tables can be styled and customized easily. Once a table is created and a cell in the table is selected, a menu called “Table Design” appears. This tab has options and commands such as: 
<ul class="list-disc list-inside">
<li> Resize </li>
<li> Remove duplicates </li>
<li> Convert to range </li>
<li> Style options (total row, banded row, header row, etc.) </li>
<li> Formatting </li>
<li> Table Name </li>
</ul> <br>
...
The size of a table can be increased or decreased based on the table range. There are three ways to resize a table. Those ways include:
<ul class="list-disc list-inside">
<li> Resize table command </li>
