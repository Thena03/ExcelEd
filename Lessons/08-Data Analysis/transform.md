...
<br><br>
<strong> Tip: </strong> To sort a range with multiple columns, the entire range must be selected. Sorting only one column in a range will break the relationship between columns.
</div>
<br>
<div class="bg-white border-l-4 border-green-600 p-4 rounded-lg mb-6 shadow-sm"> 
...
<br>
In this example, the table is being filtered by cell color. As shown in the dropdown menu, filters can be cleared from tables if needed. <br><br>
Filter options allows you to sort and filter columns by specific conditions as shown in the filter dropdown menu. 
