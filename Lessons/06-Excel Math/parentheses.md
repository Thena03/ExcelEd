...
<li> Learning the purpose of parentheses in Excel. </li>
<li> Learning the function of nested parentheses. </li>
</ul>
</div>
...
<br> <br>
<p align="center">
  <img src="{{ '/static/paren.png' | relative_url }}" alt="Excel Parentheses example"/> </p>
<br>
</div>
...
<br><br>
<p align="center">
  <img src="{{ '/static/nested-paren.png' | relative_url }}" alt="Excel Nested Parentheses example"/> </p>
</div>
