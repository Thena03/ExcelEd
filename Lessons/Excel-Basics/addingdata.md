...
<p align="center">
  <img src="/static/workbook.png" alt="Excel Adding Data example">
</p>
</div>
...
<p align="center">
  <img src="/static/deletingdata.png" alt="Excel Deleting Data example">
</p>
</div>

<div class="bg-white border-l-4 border-green-600 p-4 rounded-lg mb-6 shadow-sm">
<h2 class="text-2xl font-semibold text-center mb-4">Range Operations</h2>
...
![Excel Drag and mark a range example](/images/ribbon.png)
</div>
...
![Excel How to Fill example](/images/ribbon.png)
...
<p class="font-semibold">Filling can be used for:</p>
<ul class="list-disc list-inside"> 
